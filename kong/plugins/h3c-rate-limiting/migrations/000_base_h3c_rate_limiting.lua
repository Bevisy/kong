return {
  postgres = {
    up = [[
      CREATE TABLE IF NOT EXISTS "h3c_ratelimiting_metrics" (
      ...
      CREATE OR REPLACE FUNCTION "h3c_increment_rate_limits" (a_id UUID, i TEXT, p TEXT, p_date TIMESTAMP WITH TIME ZONE, v INTEGER) RETURNS void
      LANGUAGE plpgsql
      AS $$
        BEGIN
          LOOP
            ...
            BEGIN
              INSERT INTO h3c_ratelimiting_metrics (identifier, period, period_date, api_id, value)
      ...
      CREATE OR REPLACE FUNCTION "h3c_increment_rate_limits" (r_id UUID, s_id UUID, i TEXT, p TEXT, p_date TIMESTAMP WITH TIME ZONE, v INTEGER) RETURNS void
      LANGUAGE plpgsql
      AS $$
        BEGIN
          LOOP
      ...
      CREATE OR REPLACE FUNCTION "h3c_increment_rate_limits_api" (a_id UUID, i TEXT, p TEXT, p_date TIMESTAMP WITH TIME ZONE, v INTEGER) RETURNS void
      LANGUAGE plpgsql
      AS $$
        BEGIN
          LOOP
