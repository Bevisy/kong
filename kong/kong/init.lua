...
local function plugins_map_wrapper()
  ...
  if plugins_map_version ~= version then
    ...
    elseif singletons.configuration.database == "mysql" then
      -- mysql_timeout is defined in ms
      timeout = singletons.configuration.mysql_timeout / 1000
    end
